...
module.exports = function(environment) {
  ...
  let ENV = {
    ...
    STAFF_ADMIN_PASSWORD: process.env.STAFF_ADMIN_PASSWORD,
    CONSORTIUM_ADMIN_PASSWORD: process.env.CONSORTIUM_ADMIN_PASSWORD,
    ORGANIZATION_ADMIN_PASSWORD: process.env.ORGANIZATION_ADMIN_PASSWORD,
