...
module('Unit | Model | user', function(hooks) {
  ...
  test('should have meta data', function(assert) {
    ...
    let meta = {dois: [ {id: '2011',title: '2011',count: 1}, {id: '2020',title: '2020',count: 1} ],
      published: [ {id: '2018',title: '2018',count: 1}, {id: '2020',title: '2020',count: 1} ],
      resourceTypes: [ {id: 'text',title: 'Text',count: 1}, {id: 'dataset',title: 'Dataset',count: 1} ],
      citations: []};
