...
moduleForModel('client', 'Unit | Model | client', {
  needs: ['model:provider', 'model:repository', 'validator:presence', 'validator:confirmation', 'validator:format', 'validator:length', 'validator:client-id', 'validator:unique-client-id']
});
